...
FLAGS_NO_STD = -W -Wall  -pedantic-errors -O3 -I$(SOURCE_DIR) -I$(INCLUDE_DIR) -I/usr/include/python$(PYTHON_VERSION)
FLAGS = $(FLAGS_NO_STD) -std=c++0x
# LINK_FLAGS = -L$(LIBS_DIR) -ljson -lpython$(PYTHON_VERSION) -lboost_python -lgflags -llinear -lblas -lrt -lpthread
# LINK_FLAGS = -L$(LIBS_DIR) -lpython$(PYTHON_VERSION) -lboost_python -lgflags -llinear -lblas -lrt -lpthread
LINK_FLAGS = -L$(LIBS_DIR) -lpython$(PYTHON_VERSION) -lboost_python -lgflags -llinear -lblas -lrt -lpthread
